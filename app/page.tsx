  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 flex flex-col items-center">
        {/* Header */}
        <header className="w-full max-w-6xl py-8 px-4">
          <div className="flex justify-between items-center">
            {/* Logo */}
            <div className="flex items-center gap-3">
              <Image src="/logo-whiter.png" alt="Versatile ID Logo" width={40} height={40} />
              <span className="text-white text-base sm:text-xl font-orbitron font-black tracking-[-0.05em]">VERSATILE.ID</span>
            </div>
            ...
            <nav className="flex gap-4 sm:gap-8">
              <a 
                href="#" 
                className="text-white pb-1 border-b-2 text-sm sm:text-base"
                style={{
        ...
        {/* Divider */}
        <div className="w-full max-w-7xl border-b border-[#FFF] px-4"></div>

        {/* Welcome Text */}
        <div className="w-full max-w-6xl mt-8 mb-8 px-4">
          <span 
        ...
        {/* Main Content */}
        <section className="w-full max-w-6xl flex flex-col lg:flex-row items-start gap-8 px-4 pb-12">
          {/* Left Column */}
